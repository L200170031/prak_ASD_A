...
#1.
mh1 = mahasiswa("mamat", 20017001, "boyolali", 11000)
mh2 = mahasiswa("salman", 200170023, "klaten", 14000)
mh3 = mahasiswa("alfarisi", 20017005, "solo", 7000)
mh4 = mahasiswa("josse", 20017007, "sukoharjo", 32000)
mh5 = mahasiswa("mata", 20017009, "sragen", 12000)
